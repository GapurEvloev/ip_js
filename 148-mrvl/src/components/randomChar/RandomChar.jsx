      ...
      <div className="randomchar__block">
        ...
        <div className="randomchar__info">
          ...
          <div className="randomchar__btns">
            <a href="src/components/randomChar/RandomChar#" className="button button__main">
              <div className="inner">homepage</div>
            </a>
            <a href="src/components/randomChar/RandomChar#" className="button button__secondary">
